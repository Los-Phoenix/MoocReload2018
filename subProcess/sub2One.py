...
def main():
    ...
    convertMultiple(rootdir + cr1, rootdir + cn1 + '.txt2')
    convertMultiple(rootdir + cr2, rootdir + cn2 + '.txt2')
    convertMultiple(rootdir + cr3, rootdir + cn3 + '.txt2')
    convertMultiple(rootdir + cr4, rootdir + cn4 + '.txt2')
